...
// I modified this file because of the memory leak. The only thing I changed - allocating buffer dynamically and destroying the image.
// You can't use a static buffer because XDestroyImage frees it. Without XDestroyImage there is a memory leak after XCreateImage.
...
int main(int, const char **)
{
  ...
  buffer = (uint32_t*)calloc(SCREEN_HEIGHT * SCREEN_WIDTH, sizeof(uint32_t));
